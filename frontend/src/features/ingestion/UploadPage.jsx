    ...
    <div className="upload-page">
      <header className="upload-heading">
        <span className="upload-eyebrow">
          <Icon name="spark" size={14} /> DIMULAI DARI KELENGKAPAN KONSEP AJAR
        </span>
        ...
        <div className="upload-highlights">
          <span>Pembuka yang kontekstual</span>
          <i>·</i>
          <span>Penjelasan yang lengkap</span>
          <i>·</i>
          <span>Kesimpulan mandiri</span>
        </div>
      </header>
      ...
      <section className="upload-settings" aria-label="Pengaturan hasil cuplikan">
        <div className="subtitle-setting">
          <h2 id="subtitle-choice-title">
            <Icon name="edit" size={18} /> Gaya Subtitle
          </h2>
          ...
          <div className="subtitle-options" role="radiogroup" aria-labelledby="subtitle-choice-title">
            {[
              ['clean', 'Bersih'],
              ['active_word_highlight', 'Sorotan Kata Aktif'],
            ].map(([style, label]) => (
          ...
          <div className={`subtitle-sample ${subtitleStyle === 'active_word_highlight' ? 'is-highlighted' : ''}`}>
            Satu konsep, <mark>satu pemahaman</mark> utuh.
          </div>
        </div>
        <div className="duration-setting">
          <h2>
            <Icon name="clock" size={18} /> Durasi Tiap Klip
          </h2>
          <p>Ringkas, dengan penjelasan yang tetap lengkap.</p>
          <div className="duration-summary">
            <strong>
              25–75 <span>detik</span>
            </strong>
            <span className="clip-count">3–5 klip edukatif</span>
          </div>
